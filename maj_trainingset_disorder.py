...
Nsamples = 2000
# Generate samples
Ugly_DIDV = np.zeros((Nsamples, 28, 28))
for i in range(Nsamples):
    ...
    wire = make_wire(onsite_sc_ugly, N=N0)
    Ugly_DIDV[i] = draw_diagram(wire, N=N0, chemical_disorder=1.0)

np.save('Ugly_majsts_data.npy', Ugly_DIDV)
