...
Nsamples = 2000
# Generate samples
Good_DIDV = np.zeros((Nsamples, 28, 28))
...
for i in range(Nsamples):
    ...
    wire = make_wire(onsite_sc, N=N0)
    Good_DIDV[i] = draw_diagram(wire, N=N0, chemical_disorder=0.25)

np.save('True_majsts_data.npy', Good_DIDV)
